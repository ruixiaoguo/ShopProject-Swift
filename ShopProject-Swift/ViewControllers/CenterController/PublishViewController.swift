    ...
    @IBAction func dissMissButton(_ sender: UIButton) {
        ...
        for i in 1...buttons.count {
            ...
            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + Double(i) * 0.1, execute: {
                ...
                spring.toValue = SCREEN_HEIGH + 100
                spring.duration = 1
...
extension PublishViewController {
    fileprivate func setupUI() {
        ...
        let buttonSpace: CGFloat = (SCREEN_WIDTH - buttonW * maxCols - buttonMargn * 2) / (maxCols - 1)

        let startY: CGFloat = SCREEN_HEIGH / 3
...
//                            let vc = BaseNavigationController(rootViewController:vcTag)
